...
```
```{r}
# Crea una curva di sopravvivenza con Kaplan-Meier
fit <- survfit(Surv(ANNIOSSERV, EVENTO) ~ SOFAING_classe, data = data)
#fit <- survfit(Surv(data$EVENTO, data$SOFAING_classe) ~ 1)
# Plotta la curva di sopravvivenza
plot(fit, xlab = "Tempo", ylab = "Sopravvivenza", main = "Curva di sopravvivenza con Kaplan-Meier")
```
