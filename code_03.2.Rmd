...
table1(~ SEX + AGE  + AGE_classi + BMI + BMI_classi  + CCSCORE_classe  | SOFAING_classe, data=data, overall=F, extra.col=list('P-value'=pvalue))
```
...
table1(~ SEX + AGE + AGE_classi + BMI + BMI_classi + SOFAING_classe | CCSCORE_classe, data = data, overall = FALSE, extra.col = list('P-value' = pvalue_inverted))
